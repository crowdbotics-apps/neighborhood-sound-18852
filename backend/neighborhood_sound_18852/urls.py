"""neighborhood_sound_18852 URL Configuration
...
admin.site.site_header = "Neighborhood Sound"
admin.site.site_title = "Neighborhood Sound Admin Portal"
admin.site.index_title = "Neighborhood Sound Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="Neighborhood Sound API",
        default_version="v1",
        description="API documentation for Neighborhood Sound App",
    ),
    public=True,
